...
56 cells; PASS 42 (75%); gaps: keep_all_sentinel 0, venue_unreachable 0, bank_full 0, no_route_available 1, inventory_bug 13
...
|---|---|---|---|
| active_task | liveness | golden_egg | in_bag/qty_full IB · in_bag/slot_full IB · owned/qty_full PASS · owned/slot_full IB |
...
| combat_weapon | liveness | copper_dagger | in_bag/qty_full IB · in_bag/slot_full IB |
| combat_weapon | safety | copper_dagger | in_bag/below_threshold PASS · in_bag/qty_full PASS · in_bag/slot_full PASS |
| committed_recipe | liveness | copper_bar | in_bag/qty_full IB · in_bag/slot_full IB |
...
| healing_consumable | liveness | cooked_chicken | in_bag/qty_full IB · in_bag/slot_full IB |
...
| working_kit | liveness | copper_axe | in_bag/qty_full IB · in_bag/slot_full IB |
...
| active_task | PASS |
| healing_consumable | FAIL |
| combat_weapon | FAIL |
| working_kit | FAIL |
| committed_recipe | FAIL |
| goal_materials | FAIL |
| equipped | PASS |
| gear_demand | PASS |
| recipe_demand | PASS |
