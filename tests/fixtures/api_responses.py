...
class APIResponseFixtures:
    ...
    def get_character_response(
        ...
        base_response = {
            ...
            # Equipment slots
            "weapon_slot": "iron_sword" if level >= 5 else "",
            "rune_slot": "",
            "shield_slot": "",
            "helmet_slot": "leather_helmet" if level >= 3 else "",
            "body_armor_slot": "iron_chestplate" if level >= 7 else "",
            "leg_armor_slot": "leather_pants" if level >= 4 else "",
            "boots_slot": "leather_boots" if level >= 2 else "",
            "ring1_slot": "",
            "ring2_slot": "",
            "amulet_slot": "",
            "artifact1_slot": "",
