...
def create_character_characters_create_post(
    ...
    return CharacterResponseSchema(**response.json()) if response.json() is not None else CharacterResponseSchema()


def get_all_characters_characters__get(
    ...
    return DataPage_CharacterSchema_(**response.json()) if response.json() is not None else DataPage_CharacterSchema_()


def get_character_characters__name__get(
