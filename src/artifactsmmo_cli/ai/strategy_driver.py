...
def objective_step_goal(
    ...
    if isinstance(step, ObtainItem):
        # The `ObtainItem` branch used to be a 125-line if-pile here. It is
        # now the `Decision` graph in `decisions/obtain_item.py`, chained
        # from `obtain_item_decision` -- see that module and
