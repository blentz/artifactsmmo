"""
Shared Game Data Models

This module defines Pydantic models that are shared between different parts
of the system to avoid circular imports. These models handle API response
data and provide validation for game state information.
"""
