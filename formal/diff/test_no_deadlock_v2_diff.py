...
def test_ladder_has_26_entries() -> None:
    """Mirror sanity: Python ladder matches the Lean 26-element list.
    ...
    Lean side mirrors via MeansKind.allInLadderOrder.length = 26."""
