...
PREDICT_WIN_LIFESTEAL_MUTATIONS = [
    ...
    ("predict_win: drop monster protective_bubble term in killStep",
     ...
     "                 - (game_data.monster_protective_bubble(monster_code) * 0\n"),
    ("predict_win: drop monster sun_shield term in killStep",
     ...
     "                    + game_data.monster_sun_shield(monster_code) * 0) * raw_player * (200 + p.critical_strike) // 2)"),
    ...
    ("predict_win: drop monster greed boost term in dieStep",
     ...
     "                + 0 * game_data.monster_greed(monster_code) * raw_monster * (200 + m_crit) // 2\n"),
    ("predict_win: drop monster enchanted_mirror reflect term in dieStep",
     ...
     "                + game_data.monster_enchanted_mirror(monster_code) * 0 * raw_player * (200 + p.critical_strike) // 2)"),
