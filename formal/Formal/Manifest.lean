...
#check @Formal.SkillGrindSelection.beats_prefers_cheaper_chain -- cheapest whole-chain cost wins
#check @Formal.SkillGrindSelection.costlier_chain_never_beats  -- costlier chain never displaces
