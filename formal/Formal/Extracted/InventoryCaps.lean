-- GENERATED from src/artifactsmmo_cli/ai/inventory_caps.py (sha256: 3bd7c536c783bda61743bbb8ea2edc35b41bde12ba9698913da597da662d0923) — DO NOT EDIT
...
/-- Extracted module constant `DISCARD_WATERMARK_NUM` (line 54). -/
def DISCARD_WATERMARK_NUM : Int := 17

/-- Extracted module constant `DISCARD_WATERMARK_DEN` (line 55). -/
def DISCARD_WATERMARK_DEN : Int := 20

/-- Extracted module constant `EQUIPPABLE_KEEP` (line 97). -/
def EQUIPPABLE_KEEP : Int := 1

/-- Extracted module constant `CONSUMABLE_KEEP` (line 109). -/
def CONSUMABLE_KEEP : Int := 999

/-- Extracted from `overstock_excess` (line 67). -/
...
/-- Extracted from `_is_dominated_pure` (line 137). -/
...
/-- Extracted from `_task_chain_demand_pure` (line 261; the Python `fuel <= 0` guard
...
/-- Extracted from `useful_quantity_cap_excl_equipped_pure` (line 287). -/
...
/-- Extracted from `useful_quantity_cap_pure` (line 334). -/
