-- GENERATED from src/artifactsmmo_cli/ai/inventory_caps.py (sha256: b4f50b9c53924c87cadf0ddd75195dc82d70bba5793b205bbb62a60f5c51ff8d) — DO NOT EDIT
...
/-- Extracted from `_is_dominated_pure` (line 146). -/
...
/-- Extracted from `_task_chain_demand_pure` (line 272; the Python `fuel <= 0` guard
...
/-- Extracted from `useful_quantity_cap_excl_equipped_pure` (line 298). -/
...
/-- Extracted from `useful_quantity_cap_pure` (line 345). -/
