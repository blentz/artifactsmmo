-- GENERATED from src/artifactsmmo_cli/ai/inventory_caps.py (sha256: 4ea9794c4ce5642f197913abad97506462e7e12f2fc6c757f32807330019defa) — DO NOT EDIT
...
/-- Extracted module constant `EQUIPPABLE_KEEP` (line 124). -/
def EQUIPPABLE_KEEP : Int := 1

/-- Extracted module constant `CONSUMABLE_KEEP` (line 136). -/
def CONSUMABLE_KEEP : Int := 999

/-- Extracted from `overstock_excess` (line 94). -/
...
/-- Extracted from `_is_dominated_pure` (line 252). -/
...
/-- Extracted from `_task_chain_demand_pure` (line 386; the Python `fuel <= 0` guard
...
/-- Extracted from `useful_quantity_cap_excl_equipped_pure` (line 412). -/
...
/-- Extracted from `useful_quantity_cap_pure` (line 459). -/
