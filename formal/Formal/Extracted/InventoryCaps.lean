-- GENERATED from src/artifactsmmo_cli/ai/inventory_caps.py (sha256: 6b7ce7f27e67c84b6fb6e9a328a144b48bdbd01f2210925123cf7272012e30d7) — DO NOT EDIT
...
/-- Extracted module constant `EQUIPPABLE_KEEP` (line 119). -/
def EQUIPPABLE_KEEP : Int := 1

/-- Extracted module constant `CONSUMABLE_KEEP` (line 131). -/
def CONSUMABLE_KEEP : Int := 999

/-- Extracted from `overstock_excess` (line 89). -/
...
/-- Extracted from `_is_dominated_pure` (line 232). -/
...
/-- Extracted from `_task_chain_demand_pure` (line 364; the Python `fuel <= 0` guard
...
/-- Extracted from `useful_quantity_cap_excl_equipped_pure` (line 390). -/
...
/-- Extracted from `useful_quantity_cap_pure` (line 437). -/
