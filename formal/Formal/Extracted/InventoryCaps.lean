-- GENERATED from src/artifactsmmo_cli/ai/inventory_caps.py (sha256: 10d8c865ad41a7057033c80cd6a410b848f0b2b4c1e39d30a373ce84f8ee04bd) — DO NOT EDIT
...
/-- Extracted from `_task_chain_demand_pure` (line 361; the Python `fuel <= 0` guard
...
/-- Extracted from `useful_quantity_cap_excl_equipped_pure` (line 387). -/
...
/-- Extracted from `useful_quantity_cap_pure` (line 434). -/
