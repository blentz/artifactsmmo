-- GENERATED from src/artifactsmmo_cli/ai/tiers/equip_value.py (sha256: 53c0fc41b00adba677d9fbc6204d43e93931781017eb810aae6d1f1c66e5817b) — DO NOT EDIT
...
def equip_value_pure (attack : Int) (resistance : Int) (hp_restore : Int) (hp_bonus : Int) (dmg : Int) (critical_strike : Int) (wisdom : Int) (prospecting : Int) (inventory_space : Int) (subtype : String) :
    Int :=
  let raw := ((((((((attack + resistance) + hp_restore) + hp_bonus) + dmg) + critical_strike) + wisdom) + prospecting) + inventory_space)
